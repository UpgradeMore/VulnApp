...
<body style="background-color: #0d0d0d;">
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <h2 data-aos="fade-up">A month full of sessions, events, labs, mentorship, virtual certification program & many more.</h2>
      <a data-aos="fade-up" data-aos-delay="200" href="#online-practice-lab" class="btn-get-started scrollto" style="text-decoration: none;"><b>Get Started</b></a>
    </div>
  </section><!-- End Hero -->
          ...
          <div class="col-sm">
            <div class="card shadow mb-4">
              ...
              <div class="card-body" style="background-color: #131417;">
                If you know a command but you don’t know how to use that particular command then try using manual (man
                page) by typing “man“ (without the quotes &lt;&gt;). Example: If you know about the “ls” command, then
                type: man ls. Press “q” to quit the man command.
                If you don’t find the man page then the command might be a shell built-in. In this case, use the “help“.
                Example: “help cd“
                Lastly, if you are still stuck somewhere make sure you join our discord server.
              </div>
            </div>
            <button type="button" class="btn btn-primary"><a href="" style="color: #fff; text-decoration: none;font-size: 20px;"><b>Start Now</b></a></button>
          </div>
          <div class="col-sm">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
...
<script type="text/javascript">(function(){window['__CF$cv$params']={r:'6dad6bb50e3e0e2c',m:'Fl49W5Si0h22v3bjrfBKB4kFpSFxRvlI4AT7AEjC4BE-1644413095-0-AS+CLwB7dipBwLppposWKM9yOj7KodpT1z+kMzJ67hZjfbVt8NKy2rRYKEx9sBAg/Fk5Xi4CdPpsHVmLMz+EL/yTC68oHMXftoQlOaHt3BXelDvdKo/26VGqZMgvrFQSMQ2RmRX2Z/OtE+ggwC0Lxa4Z5VEA3SGD9qP+ytR6mwdy/CW+thwachGM4qfhz0XJTg==',s:[0x9f0e4ab1d9,0xfe32560292],}})();</script></body>
