        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" style="background-color: #000;">
                ...
                <div id="main">
                    ...
                    <h1 style="margin-left: 25px;"><b>Denial-of-Service (SSL-Exhaustion)</b></h1>
                    <div class="card shadow mb-4" style="margin-left: 25px; margin-right: 300px;margin-top: 20px;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">The Lighttpd web server is vulnerable to SSL-exhaustion attacks! (<a href="http://sourceforge.net/projects/bwapp/files/bee-box/" target="_blank"><span style="color: #808080">bee-box</span></a> only)</h6>
                        </div>
                        <div class="card-body">
